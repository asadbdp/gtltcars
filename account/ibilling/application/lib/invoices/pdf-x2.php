    ...
    <table width="100%">
        <tr>
            <td style="border: 0;  text-align: left" width="62%">
                <span style="font-size: 40px; color: #000000"><strong><?php echo $_L['INVOICE']; ?></strong></span>
            </td>
    ...
    ?>
     <table width="100%">
        <tr>
            ...
            <td style="border: 0;  text-align: center" width="62%"><div id="text" style="font-size:18px">
                       <span style="font-size: 14px; color: #000000">SIGNATURE</span><br><br> <br>
