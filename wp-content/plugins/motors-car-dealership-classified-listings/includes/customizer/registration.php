...
$listing_features = array(
    ...
    'compare_archive' => array(
        'label' => esc_html__('Compare page', 'stm_vehicles_listing'),
        'type' => 'stm-post-type',
        'post_type' => 'page',
        'description' => esc_html__('Choose compare page', 'stm_vehicles_listing'),
        'default' => ''
    ),
...
STM_Customizer_Vehicle::setSection('user_dealer', array(
    ...
    'fields' => array(
        ...
        'user_post_limit' => array(
            'label' => esc_html__('User Posts Limit:', 'stm_vehicles_listing'),
            'type' => 'text',
            'default' => esc_html__('3', 'stm_vehicles_listing'),
        ),
        'user_post_images_limit' => array(
            'label' => esc_html__('User Post Images Upload Limit:', 'stm_vehicles_listing'),
            'type' => 'text',
