		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header modal-header-iconed">
					...
					<h3 class="modal-title" id="myModalLabel"><?php esc_html_e('Request car price', 'stm_vehicles_listing') ?></h3>
					<div class="test-drive-car-name"><?php echo get_the_title(get_the_id()); ?></div>
				</div>
