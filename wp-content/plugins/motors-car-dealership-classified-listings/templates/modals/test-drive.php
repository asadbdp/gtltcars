		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header modal-header-iconed">
					...
					<h3 class="modal-title" id="myModalLabelTestDrive"><?php esc_html_e('Schedule a Test Drive', 'stm_vehicles_listing') ?></h3>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<div class="form-modal-label"><?php esc_html_e('Best time', 'stm_vehicles_listing'); ?></div>
