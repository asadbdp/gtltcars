...
<?php if ($show_price and !$show_sale_price): ?>
        ...
        <div class="single-regular-price text-center">
            ...
            <?php else: ?>
                <?php if (!empty($regular_price_label)): ?>
                    <span class="labeled"><?php printf(__('%s', 'stm_vehicles_listing'), esc_html($regular_price_label)); ?></span>
                <?php endif; ?>
    ...
    <?php if (!empty($regular_price_description)): ?>
        <div
            class="price-description-single"><?php printf(__('%s', 'stm_vehicles_listing'), esc_html($regular_price_description)); ?></div>
    <?php endif; ?>
...
<?php if ($show_price and $show_sale_price): ?>
        ...
        <div class="single-regular-sale-price">
            ...
            <table>
                <tr>
                    <td>
                        <div class="regular-price-with-sale">
                            <?php if (!empty($special_price_label)): ?>
                                <?php printf(__('%s', 'stm_vehicles_listing'), esc_html($special_price_label)); ?>
                            <?php endif; ?>
                            <strong>
                    ...
                    <td>
                        <?php if (!empty($regular_price_label)):
                            printf(__('%s', 'stm_vehicles_listing'), esc_html($regular_price_label));
                            $mg_bt = '';
                        else:
    ...
    <?php if (!empty($instant_savings_label)): ?>
        ...
        <div class="sale-price-description-single">
            <?php printf(__('%s', 'stm_vehicles_listing'), esc_html($instant_savings_label)); ?>
