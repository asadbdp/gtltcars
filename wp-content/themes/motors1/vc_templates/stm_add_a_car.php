							...
							<div class="row">
								...
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
										...
										<input type="number" class="heading-font" name="stm_car_sale_price" />
									</div>
								</div>
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
						...
						<div class="col-md-12 col-sm-12">
							<div class="row">
								...
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
										<div class="stm_label heading-font"><?php esc_html_e('Sale Price', 'motors'); ?> (<?php echo stm_get_price_currency(); ?>)</div>
										<input type="number" class="heading-font" name="stm_car_sale_price" value="<?php echo esc_attr($sale_price); ?>" />
									</div>
								</div>
								<div class="col-md-4 col-sm-12">
									<div class="stm_price_input">
