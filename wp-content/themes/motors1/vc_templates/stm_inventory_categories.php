...
if(!empty($image)) {
	$image_url = wp_get_attachment_image_src($image, 'stm-img-796-466');
...
if(!empty($image_url) and !empty($filter_cat_main)): ?>
	...
	<div class="stm_mc-image-category">
		...
		<div class="links">
			...
			<a class="heading-font" href="<?php echo esc_url(add_query_arg($filter_cat_main[1], $filter_cat_main[0], stm_get_listing_archive_link())); ?>">
